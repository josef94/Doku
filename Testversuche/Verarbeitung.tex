...
\begin{figure}[H]
  \centering
  \subfigure[Originalbild mit Rahmen]{\includegraphics[width=0.45\textwidth]{Testversuche/GrabCut1.jpg}}
  \subfigure[Ergebnis des Algorithmus]{\includegraphics[width=0.45\textwidth]{Testversuche/GrabCut2.jpg}}
...
\begin{figure}[H]
  \centering
  \subfigure[Originalbild nach "'GrabCut"']{\includegraphics[width=0.45\textwidth]{Testversuche/Clustering1.jpg}}
  \subfigure[Ergebnis des Clustering Algorithmus]{\includegraphics[width=0.45\textwidth]{Testversuche/Clustering2.jpg}}
...
\begin{figure}[H]
  \centering
  \subfigure[Originalbild des Verkehrsteilnehmers]{\includegraphics[width=0.45\textwidth]{Testversuche/Categorize1.jpg}}
  \subfigure[Gezählte Pixel mit "'CountNonZero"']{\includegraphics[width=0.45\textwidth]{Testversuche/Categorize2.jpg}}
...
\begin{figure}[H]
  \centering
  \subfigure[Originalbild des Verkehrsteilnehmers]{\includegraphics[width=0.45\textwidth]{Testversuche/Velocity1.jpg}}
  \subfigure[Ergebnis nach "'GrabCut"' und "'CountNonZero"']{\includegraphics[width=0.45\textwidth]{Testversuche/Velocity2.jpg}}
