...
\begin{figure}[H]
  \centering
  \subfigure[Frame1]{\includegraphics[width=0.40\textwidth]{Software/Frame1.jpg}}
  \subfigure[Frame2]{\includegraphics[width=0.40\textwidth]{Software/Frame2.jpg}}
...
\begin{figure}[H]
\centering
	\subfigure[Blob Frame 1]{\includegraphics[scale=0.32]{Software/Blob1.jpg}}\quad
   \subfigure[Bild Frame 1]{\includegraphics[scale=0.32]{Software/Detection1.jpg}}\\
   \subfigure[Blob Frame 2]{\includegraphics[scale=0.32]{Software/Blob2.jpg}}\quad
   \subfigure[Bild Frame 2]{\includegraphics[scale=0.32]{Software/Detection2.jpg}}\\
   \subfigure[Blob Frame 3]{\includegraphics[scale=0.32]{Software/Blob3.jpg}}\quad
   \subfigure[Blob Frame 3]{\includegraphics[scale=0.32]{Software/Detection3.jpg}}
